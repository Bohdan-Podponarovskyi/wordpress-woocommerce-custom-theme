...
?>
<header class="woocommerce-products-header products__header--woocommerce">
	<?php
	/**
	...
	if ( apply_filters( 'woocommerce_show_page_title', true ) ) :
		?>
		<h1 class="woocommerce-products-header__title page-title heading--h3"><?php woocommerce_page_title(); ?></h1>
	<?php endif; ?>
